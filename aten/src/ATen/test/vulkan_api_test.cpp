...
void test_softmax_4d(int64_t dim) {
  ...
  at::Tensor test_in[] = {
    at::rand({1, 3, 4, 2}, at::TensorOptions(at::kCPU).dtype(at::kFloat)).contiguous(),
    at::rand({6, 13, 16, 7}, at::TensorOptions(at::kCPU).dtype(at::kFloat)).contiguous(),
    at::rand({9, 16, 21, 21}, at::TensorOptions(at::kCPU).dtype(at::kFloat)).contiguous(),
  };
